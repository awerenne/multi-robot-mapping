...
bool Anomalies::isIntersection() {
    return (isBlackLeft() || isBlackRight() || !isBlackFront());
}


//============
byte Anomalies::typeIntersection() {
    bool bl = isBlackLeft(), br = isBlackRight(), bf = isBlackFront();
...
bool Anomalies::isBlackLeft() {
    return p_left >= 0.05;  // 0.35
}


//============
bool Anomalies::isBlackRight() {
    return p_right >= 0.05;  // 0.35
}


//============
bool Anomalies::isBlackCenter() {
    return p_center >= 0.75;
}
