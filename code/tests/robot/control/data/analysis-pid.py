...
# Full view
plt.plot(df['seq_number'], df['measured_speed'], c='skyblue', label='measured speed')
plt.plot(df['seq_number'], df['progress_speed'], c='red',  label='progress speed')
plt.ylim([5,9])
plt.xlabel('t', fontsize=12)
plt.ylabel('Linear velocity (cm/s)', fontsize=12)
...
plt.plot(np.arange(discretize_factor), y, c='black', label='measured speed')
